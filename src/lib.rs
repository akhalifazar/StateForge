...
#[derive(Debug)]
pub struct StateForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StateForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StateForge processing");
    
    let mut processor = StateForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StateForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StateForgeProcessor::new(false);
